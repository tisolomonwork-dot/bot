  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-background">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
            <Suspense fallback={<Skeleton className="h-[76px] rounded-lg" />}>
                <BalancePnl />
            </Suspense>
        </div>
        <div className="grid grid-cols-1 gap-4 md:gap-6">
            <Suspense fallback={<Skeleton className="h-[92px] rounded-lg" />}>
                <ActiveTrade />
            </Suspense>
        </div>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 md:gap-6">
            <div className="lg:col-span-2 flex flex-col gap-4 md:gap-6">
            <Suspense fallback={<Skeleton className="h-[188px] rounded-lg" />}>
                <AiOpinionCard />
            </Suspense>
            <Suspense fallback={<Skeleton className="h-[478px] rounded-lg" />}>
                <CandlestickChart />
            </Suspense>
            </div>
            <div className="lg:col-span-1">
                <Suspense fallback={<Skeleton className="h-[386px] rounded-lg" />}>
                    <TradePanel />
                </Suspense>
            </div>
        </div>
